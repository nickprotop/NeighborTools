            ...
            try
            {
                if (initialStatus == RentalStatus.Approved)
                {
                    ...
                    var approvalNotification = new RentalApprovedNotification
                    {
                        ...
                        ToolLocation = !string.IsNullOrEmpty(createdRental.Tool.Location) ? createdRental.Tool.Location : createdRental.Tool.Owner.PublicLocation ?? "Location not available",
        ...
        try
        {
            ...
            try
            {
                var approvalNotification = new RentalApprovedNotification
                {
                    ...
                    ToolLocation = !string.IsNullOrEmpty(rental.Tool.Location) ? rental.Tool.Location : rental.Tool.Owner.PublicLocation ?? "Location not available",
