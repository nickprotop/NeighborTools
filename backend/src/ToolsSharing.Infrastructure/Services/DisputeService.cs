...
public class DisputeService : IDisputeService
{
    ...
    private async Task<DisputeDetailsDto> MapToDisputeDetailsAsync(Dispute dispute)
    {
        return new DisputeDetailsDto
        {
            ...
            RentalStartDate = dispute.Rental?.StartDate ?? DateTime.SpecifyKind(DateTime.MinValue, DateTimeKind.Utc),
            RentalEndDate = dispute.Rental?.EndDate ?? DateTime.SpecifyKind(DateTime.MinValue, DateTimeKind.Utc),
